/*
 * 文 件 名:  AlarmTaskWaitingTimeoutStatistics.java
 ...
 */
public class TaskWaitingTimeoutStat {
     ...
     * 无参构造
     */
    public TaskWaitingTimeoutStat() {
    }

    public TaskWaitingTimeoutStat(String jobId, String jobName, long waitingTimeoutCount,
                                  double avgWaitingTime, double maxWaitingTime) {
        this.jobId = jobId;
