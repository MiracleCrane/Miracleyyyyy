/*
 * 文 件 名:  StreamJobFailAlarmRule.java
...
import com.huawei.smartcampus.datatool.monitor.domain.alarm.rule.condition.StreamJobFailAlarmCondition;
 ...
 */
public class StreamJobFailAlarmRule implements AlarmRule {
    private AlarmType alarmType = AlarmType.STREAM_JOB_FAIL;

    private AlarmCondition condition = new StreamJobFailAlarmCondition();
